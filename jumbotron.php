...
<div class="card-group">
  <div class="card">
    <img class="card-img-top" src="<?php echo get_stylesheet_directory_uri(); ?>/images/camera.jpg" alt="Card image cap">
    <div class="card-body">
  ...
  <div class="card">
    <img class="card-img-top" src="<?php echo get_stylesheet_directory_uri(); ?>/images/marca.jpg" alt="Card image cap">
    <div class="card-body">
  ...
  <div class="card">
    <img class="card-img-top" src="<?php echo get_stylesheet_directory_uri(); ?>/images/code.jpg" alt="Card image cap">
    <div class="card-body">
